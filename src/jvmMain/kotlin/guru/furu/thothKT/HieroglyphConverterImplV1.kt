...
import guru.furu.thothKT.util.codeToGlyphMapV1

class HieroglyphConverterImplV1 : HieroglyphConverter {
        ...
        split.forEach { glyph ->
            ...
            when {
                glyph.startsWith('[') && glyph.endsWith(']') -> {
                    ...
                    val unwrappedGlyph = glyph.substring(1, glyph.length - 1)
                ...
                checkForComputerEncoding(glyph) -> {
                    ...
                    val glyphLookup = codeToGlyphMapV1[glyph]
