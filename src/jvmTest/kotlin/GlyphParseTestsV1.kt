...
import guru.furu.thothKT.HieroglyphConverterImplV1
...
class GlyphParseTestsV1 {

    companion object {
        val converter = HieroglyphConverterImplV1()
    }
    ...
    fun `test String extension function`() {
        ...
        assertEquals(shouldBe, input.convertToGlyphs(version = Version.V1))
    }
